...
#titulo
creditss = tkinter.Label(Menu, text = "Di Napoli todos los derechos recervados")
creditss.grid(row = 0, column = 0)
#botonVideo
playButton = tkinter.Button(Menu, text = "Play", command = lambda: game())
